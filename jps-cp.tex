...
\maketitle
\begin{abstract}
To provide a high-intensity muon beam to the COMET experiment,  pions produced from the collision of \SI{8}{\GeV} protons from the J-PARC Main Ring with a graphite target are collected using a superconducting pion capture solenoid. It is necessary to install a massive radiation shield inside the capture solenoid (CS) to protect the coils from the quench as well as radiation damage.
