...
The heat load to the coils is  \SI{\sim 13.6}{\watt} in total and 
the neutron (\SI{>0.1}{\MeV}) fluence to the coils in 150 days beam time is $\Phi_n \sim 1\times10^{16}~\unit{\per\square\cm}$ at maximum position.
...
%  \centering
%  \subfloat[Heat load]{%
%    \includegraphics[width=0.45\textwidth]{fig/CSHeatLoad.pdf}
%  }
%  \hfill
%%  \begin{subfigure}{0.45\textwidth}
%%    \centering
%%    \includegraphics[width=\linewidth]{fig/CSHeatLoad.pdf}
%%    \caption{Heat load density}
%%  \end{subfigure}
%%  \hfill
%  \subfloat[Caption for right figure]{%
%    \includegraphics[width=0.45\textwidth]{CSNeutronFluence.pdf}
%  }
%%  \begin{subfigure}{0.45\textwidth}
%%    \centering
%%    \includegraphics[width=\linewidth]{CSNeutronFluence.pdf}
%%    \caption{Neutron fluence}
%%  \end{subfigure}
%  \caption{Two figures side by side using subcaption}
%  \label{fig:CSImpact}
%\end{figure}
