...
Five SS304 modules placed at the top side, where the beam is away, were modified in 2024 to have a straight shape at the downstream side
 as shown in Fig.~\ref{fig:a} to reduce the air dose rate outside the beam room, especially above ground.
...
The heat load to the coils is  \SI{\sim 12}{\watt} in total and 
the neutron fluence to the coils in 150 days beam time is $\Phi_n \sim 3\times10^{16}~\unit{\per\square\cm}$ at maximum position.
